...
if uploaded_file:
    ...
    try:
        ...
        if missing_columns:
            ...
            st.markdown(
                "<h2>Sentiment Analysis of Classroom Spaces by Buildings</h2>",
                unsafe_allow_html=True,
            )
            ...
            if selected_theme:
                ...
                for res in responses_sorted[:6]:  # Display up to 6 responses (2:2:2 distribution if possible)
            ...
            if selected_building:
                ...
                building_data = building_summary.loc[building_summary["Buildings Name"] == selected_building].iloc[0]
                st.write(f"**Average Sentiment Score:** {building_data['Avg_Sentiment']:.2f}")
                st.write(f"**Total Responses:** {building_data['Count']}")
