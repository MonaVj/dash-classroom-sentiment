...
if uploaded_file:
    ...
    try:
        ...
        if missing_columns:
            ...
            st.markdown(
                "<h2>Overall Sentiment Analysis of Classroom Spaces by Buildings</h2>",
                unsafe_allow_html=True,
            )
            ...
            if selected_building:
                ...
                if avg_sentiment > 0.2:
                    recommendation = f"The sentiment for {selected_building} is positive. Maintain strengths and focus on modern collaborative spaces."
                elif -0.2 <= avg_sentiment <= 0.2:
                    recommendation = f"The sentiment for {selected_building} is neutral. Focus on improvements in lighting and seating arrangements."
                else:
                    recommendation = f"The sentiment for {selected_building} is negative. Prioritize redesigning outdated spaces and improve accessibility."
