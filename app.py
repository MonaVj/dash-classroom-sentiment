...
if uploaded_file:
    try:
        ...
        # Preprocess Data
        df = df.dropna(subset=["Latitude", "Longitude", "Tell us about your classroom"])
        ...
        # Add response counts if not present
        ...
        if selected_theme:
            ...
            st.dataframe(grouped_theme_data_display)
            ...
            # Display up to 6 responses: 2 positive, 2 neutral, 2 negative
